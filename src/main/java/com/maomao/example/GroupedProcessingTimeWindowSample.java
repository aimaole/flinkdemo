...
public class GroupedProcessingTimeWindowSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple2<String, Integer>> xuqiu1 = keyedStream.sum(1);
        xuqiu1.print();

        xuqiu1.keyBy(new KeySelector<Tuple2<String, Integer>, Object>() {
            @Override
